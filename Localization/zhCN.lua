...
L.General_SelfInParty = "团队中显示你自己"
...
L.General_FadeFramesInCombat = "退出战斗时淡出框体."
L.General_FadeFramesInCombatTip = "退出战斗时隐藏框体及施法条."

L.General_showComboPoints = "启用连击点"
L.General_showComboPointsTip = "启用连击点框体"
L.General_showRunes = "启用符文"
L.General_showRunesTip = "启用死亡骑士的符文"
L.General_showAdditionalPower = "启用附加能量条"
L.General_showAdditionalPowerTip = "启用一些职业的附加法力条"
L.General_showTotems = "启用图腾"
L.General_showTotemsTip = "启用职业图腾框体（不适用于所有的职业）"
L.General_showArcaneStacks = "启用奥术充能"
L.General_showArcaneStacksTip = "启用奥术专精奥术充能效果"
L.General_showChi = "启用真气"
L.General_showChiTip = "启用踏风武僧的真气"
L.General_showStagger = "启用醉拳池"
L.General_showStaggerTip = "启用酒仙武僧的醉拳池"
L.General_showHolyPower = "启用神圣能量"
L.General_showHolyPowerTip = " 启用圣骑士的神圣能量"
L.General_showInsanity = "启用精神错乱效果"
L.General_showInsanityTip = "当使用虚空形态时，在狂乱值上覆盖一个精神错乱效果"
L.General_showShards = "启用灵魂碎片"
L.General_showShardsTip = "显示术士的灵魂碎片"
L.General_classAuraBar = "%s 增益计时器"
L.General_classAuraBarTip = "在玩家的框体上显示一个当前专精的增益buff计时条. \n输入一个法术ID来启用计时条,并可以为此设置一个颜色."
L.General_powerPredictionBar = "启用资源预见"
L.General_powerPredictionBarTip = "显示读条施法时的预计消耗效果"
L.General_builderSpender = "启用资源反馈"
L.General_builderSpenderTip = "显示职业资源点收益/消耗反馈效果"
L.General_useAtlas = "专精特色资源纹理"	
...
L.Color_Interruptible = "可断施法颜色"
L.Color_UnInterruptible = "不可断施法颜色"
...
L.Font_Number = "数值字体"
L.Font_NumberSize = "数值字体缩放"
L.Font_NumberOutline = "轮廓"
L.Font_Name = "姓名字体"
L.Font_NameSize = "姓名字体缩放"
L.Font_NameOutline = "轮廓"
L.Font_Bar = "施法条字体"
L.Font_BarSize = "施法条字体缩放"
L.Font_BarOutline = "轮廓"
L.Font_Level = "水平字体"
L.Font_LevelSize = "水平字体缩放"
L.Font_LevelOutline = "水平轮廓类型"
L.Font_HealthOffset = "生命值 Y_偏移"
L.Font_PowerOffset = "能量值 Y_偏移"
